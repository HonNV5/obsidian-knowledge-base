...
**Trạng thái:** 🚧 đang viết — Đợt 1/6 (cụm A).
...
| # | Note | Nội dung | Trạng thái |
|---|------|----------|------------|
| 4 | [[04-Prompt-Engineering-voi-Copilot\|Prompt engineering]] | 4 best practice, zero/one/few-shot, chain prompting, role prompting | 🚧 |
| 5 | [[05-Copilot-xu-ly-Prompt-va-Du-lieu\|Copilot xử lý prompt & dữ liệu]] | Pipeline 7 bước, proxy filter, data handling completion vs chat, LLM/LoRA | 🚧 |
| 6 | [[06-Copilot-Spaces\|Copilot Spaces]] | Space là gì, tạo space, sharing/security/versioning/governance | 🚧 |
