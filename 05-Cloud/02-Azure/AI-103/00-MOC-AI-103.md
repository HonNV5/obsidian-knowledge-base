...
>
> **Trạng thái:** ✅ HOÀN TẤT — đủ 20 note phủ ~30 module của 4 learning path. **19 ảnh** trong `_img/`.

> 📋 **Đã rà độ phủ nguồn (26/07/2026):** 4 file docx có **53 bảng** (bị flatten thành đoạn tab-separated khi copy, `len(doc.tables) == 0`) — **53/53 đã có trong note**, phần lớn ở dạng **nén** (gộp nhiều dòng nguồn thành một dòng bảng Việt). Nguồn có **89 ảnh**, note dùng **19** — phần bỏ qua là ảnh demo (robot ăn burger/mì của gpt-image), icon khái niệm đơn giản đã thay bằng Mermaid, và screenshot code lặp lại.
...
## Liên quan
- [[../00-MOC-Azure]] — MOC Azure tổng (AZ-900 + AI-Azure + AZ-204 + AB-100)
- [[../AB-100/00-MOC-AB100|MOC: AB-100]] — cùng hệ sinh thái Foundry nhưng **góc solution architect / business apps**: Copilot Studio, Dynamics 365, Power Platform. AB-100 cross-link ngược sang AI-103 cho MCP, A2A, model catalog, Responsible AI, multi-agent — **không lặp lý thuyết**
