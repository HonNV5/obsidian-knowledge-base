...
>
> **Trạng thái:** ✅ **HOÀN TẤT — 25/25 note + MOC** (nhập môn + **Plan** + **Design** + **Deploy** + cheatsheet ôn thi). Đã rà **7 phép thử phủ nguồn**; **35/35 câu Module assessment** trả lời được từ note.
...
| 13 | [[13-Grounding-Power-Apps-va-Well-Architected\|Grounding pipeline, Power Apps, Well-Architected & success criteria]] | Agents U10, U12-U14, U18 | ✅ |
| 14 | [[14-Extensibility-Custom-Model-M365-Copilot-MCP\|Extensibility: custom model Foundry, agent M365 Copilot, MCP]] | Extensibility U2-U5 | ✅ |
| 15 | [[15-Computer-Use-Agent-Behaviors-va-Toi-uu-M365\|Computer Use, agent behaviors & tối ưu agent trong M365]] | Extensibility U6-U8 | ✅ |
| 16 | [[16-Orchestrate-Prebuilt-Agents-va-Apps\|Điều phối agent & app dựng sẵn (D365 CS, M365 agents, Sales/Service, Power Platform, F&O)]] | Orchestrate U2-U8 | ✅ |

## Cụm C — Deploy AI-powered business solutions (40–45%) ← trọng số cao nhất

| # | Note | Module gốc | TT |
|---|------|-----------|----|
| 17 | [[17-Khung-Giam-sat-va-Cong-cu\|Khung giám sát đa tầng & công cụ]] | Monitor U1 | ✅ |
| 18 | [[18-Metrics-Telemetry-va-Tuning\|Backlog & feedback, metrics, telemetry và 4 lớp tuning]] | Monitor U2-U5 | ✅ |
| 19 | [[19-Testing-Quy-trinh-Metrics-va-Validation\|Kiểm thử: khung, 4 loại test, metrics & validation custom model]] | Testing U1-U2 | ✅ |
| 20 | [[20-Testing-Prompt-E2E-va-Sinh-Test-Case\|Validate prompt, kịch bản E2E đa app & sinh test case bằng Copilot]] | Testing U3-U5 | ✅ |
| 21 | [[21-ALM-cho-Du-lieu-va-Copilot-Studio\|ALM cho dữ liệu AI & cho Copilot Studio]] | ALM U1-U2 | ✅ |
| 22 | [[22-ALM-cho-Foundry-Custom-Model-va-D365\|ALM cho Foundry agents, custom model & Dynamics 365]] | ALM U3-U6 | ✅ |
| 23 | [[23-Bao-mat-Agent-Model-va-Access-Control\|Bảo mật agent, model security, access control & audit trail]] | RAI-Sec U1, U3, U7-U8 | ✅ |
| 24 | [[24-Governance-Data-Residency-va-Responsible-AI\|Governance, lỗ hổng AI, Responsible AI & data residency]] | RAI-Sec U2, U4-U6 | ✅ |

## Cụm D — Ôn thi

| # | Note | Nguồn | TT |
|---|------|-------|----|
| 25 | [[25-AB-100-Cheatsheet-va-QA\|Cheatsheet: bảng tra nhanh, 6 bảng cặp dễ nhầm, **35 câu Module assessment** dịch + giải thích, Q&A phỏng vấn]] | Tổng hợp cả 11 module | ✅ |
